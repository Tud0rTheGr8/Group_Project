...
formula_e_tidy[312,13] <- "56:27.535"
formula_e_tidy[324,13] <- "+1:01.365"
formula_e_tidy[325,13] <- "+1:09.646"
formula_e_tidy[472,13] <- "+39.137"
formula_e_tidy[473,13] <- "+55.189"
formula_e_tidy[549,13] <- "+1:13.880"
formula_e_tidy[550,13] <- "+1:31.382"
formula_e_tidy[836,13] <- "+1:27.00912"
```
...
inner_join(formula_e_tidy, formula_e_time, by = "id")
```
